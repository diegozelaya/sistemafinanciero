...
document.addEventListener('DOMContentLoaded', () => {
            ...
            fetch(`/obtener_matricula/${id_matricula}`)
                ...
                .then(data => {
                    ...
                    data.cabezamatricula.forEach(cabeza => {
                        ...
                        const contratoTexto = (cabeza.contrato == 1) ? "Firmado" : "No firmado";
                        document.getElementById("infoContrato").textContent = contratoTexto;
                    });
                ...
                .catch(error => {
                    console.error('Error al cargar el detalle de la matrícula:', error);
                    alert('No se pudo cargar el detalle de la matrícula.');
                });
        }
        ...
        if (e.target.classList.contains('editar-btn')) {
            ...
            fetch(`/obtener_matricula/${idMatricula}`)
                ...
                .then(data => {
                    ...
                    // 🔹 Contrato (si es null, se interpreta como 0)
                    const contratoCheckbox = document.getElementById("editContrato");
                    contratoCheckbox.checked = (cabeza.contrato == 1);
    ...
    document.getElementById("guardarCambiosMatricula").addEventListener("click", () => {
        console.log("Estoy en el botón guardar");
        ...
        const contratoFirmado = document.getElementById("editContrato").checked ? 1 : 0; // 🔹 nuevo campo
        ...
        const datos = {
            ...
            curso: curso,
            contrato: contratoFirmado,   // 🔹 agregado
            cuotas: cuotas
        };
